...
import com.mikaelasoares.cursomc.domain.Pagamento;
import com.mikaelasoares.cursomc.domain.PagamentoComBoleto;
import com.mikaelasoares.cursomc.domain.PagamentoComCartao;
...
import com.mikaelasoares.cursomc.repositories.ItemPedidoRepository;
import com.mikaelasoares.cursomc.repositories.PagamentoRepository;
import com.mikaelasoares.cursomc.repositories.PedidoRepository;
import com.mikaelasoares.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente (null, "Maria Silva", "miih.arj@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente (null, "Ana Costa", "miih.lhp@hotmail.com", "32510875094", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("11996584723", "21987456325"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "20106", null, "Centro", "25698741", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 12:40"), cli1, e2);
